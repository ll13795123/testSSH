...
import com.morning.hdfs_examples.pi.DistSum.Computation;
import com.morning.hdfs_examples.pi.DistSum.Parameters;
import com.morning.hdfs_examples.pi.math.Bellard;
import com.morning.hdfs_examples.pi.math.Bellard.Parameter;
import com.morning.hdfs_examples.pi.math.Summation;
...
public final class DistBbp extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    final Parameters parameters = Parameters.parse(args, i);
